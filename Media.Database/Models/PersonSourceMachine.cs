...
{
    /// <summary>
    /// Gets the integer identifier for this person/device association. Not <c>required</c>; see
    /// <see cref="Group.GroupId"/> for why.
    /// </summary>
    [JsonIgnore]
    public int PersonSourceMachineId { get; init; }
    ...
    /// <see cref="PersonSourceMachineId"/> for why.
    /// </summary>
    [JsonIgnore]
