...
namespace Media.Database.Models
{
    ...
    {
        /// <summary>
        /// The unique identifier for the source machine, generated by the server. This is also
        /// the device's permanent API key (x-api-key) and is never serialized to a client. Not
        /// <c>required</c>: System.Text.Json refuses to build type metadata for a
        /// <c>required</c> member that is also <see cref="JsonIgnoreAttribute"/>-decorated,
        /// since JSON could never satisfy it.
        /// </summary>
        [property: JsonIgnore]
        public Guid SourceMachineUuid { get; set; }
        ...
        /// (unlike <see cref="SourceMachineUuid"/>), since it carries no authentication power on its
        /// own. Together with <see cref="SourceMachineName"/> and <see cref="DeviceTypeId"/>, it lets
        /// a caller authenticated via a group-scoped key identify which of the group's devices an
        /// upload comes from.
        /// </summary>
